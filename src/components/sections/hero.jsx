  ...
  return (
    <section className="relative flex min-h-[640px] sm:min-h-[720px] md:min-h-[780px] lg:min-h-[860px] w-full items-center justify-center overflow-hidden bg-black px-4 pb-28 pt-28 text-white sm:px-6 md:pb-48 md:pt-44 lg:px-8">
      ...
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
        ...
        {/* Degradê inferior suave para leitura perfeita */}
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center text-center">
        <div className="flex flex-col items-center gap-5 sm:gap-6 md:gap-8">
          <Reveal>
            <h1 className="font-display text-4xl font-extralight tracking-tight text-white sm:text-6xl md:text-7xl lg:text-[5.5rem] md:leading-tight">
              {title}
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.16} className="w-full sm:w-auto pt-2 md:pt-4">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto rounded-full bg-[#E5484D] px-8 py-6 text-base font-normal text-white shadow-xl transition-all duration-300 hover:scale-105 hover:bg-[#E5484D]/90 focus-visible:ring-2 focus-visible:ring-white md:text-lg"
            >
